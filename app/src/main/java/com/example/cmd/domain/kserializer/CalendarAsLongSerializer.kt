package com.example.cmd.domain.kserializer
...
object CalendarAsLongSerializer : KSerializer<Calendar> {
  ...
  override fun deserialize(decoder: Decoder): Calendar = Calendar.getInstance().apply { timeInMillis = decoder.decodeLong() }
}
