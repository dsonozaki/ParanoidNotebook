...
class SelectItemDialog: DialogFragment() {
  override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
    val message = arguments?.getString(MESSAGE) ?: throw RuntimeException("Message absent in SelectItemDialog")
    val title = arguments?.getString(TITLE) ?: throw RuntimeException("Title absent in SelectItemDialog")
