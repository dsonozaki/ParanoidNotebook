...
import com.example.cmd.domain.usecases.filesDatabase.ChangeFilePriorityUseCase
import com.example.cmd.domain.usecases.filesDatabase.ChangeSortOrderUseCase
import com.example.cmd.domain.usecases.filesDatabase.ClearDbUseCase
...
import com.example.cmd.domain.usecases.filesDatabase.InsertMyFileUseCase
...
@HiltViewModel
class FilesSettingsVM @Inject constructor(
